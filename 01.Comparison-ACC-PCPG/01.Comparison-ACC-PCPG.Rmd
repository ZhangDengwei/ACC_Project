...
# meta data from TCGA website
df_meta_ACC_2 <- read.delim("../00.Data/ACC_77_meta.txt")
...
# PCoA examination, only for primary tumor
...
#pdf(file = "Figures/Comparison_PCA_ACC-PCPG.pdf", width = 7.5, height = 5)
pca_nor
pca_nor_likely
